...
This project utilises a **Multivariate Time-Series approach** to predict Total Electricity Generation. By training a machine and deep learning model on historical data **(2009–2026)** from the **NESO Data Bank Portal of Historical Generation Mix**, the model identifies seasonal rhythms, daily demand ramps, and long-term trends to provide actionable grid analytics using **16 years of half-hourly Great Britain operational energy mix data (1.14 billion MW records).**
